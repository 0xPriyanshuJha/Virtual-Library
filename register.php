...
<html lang="en">
  ...
  <script src="https://use.fontawesome.com/releases/v5.0.8/js/all.js"></script>
    <title>Register|Virtual Library</title>
  </head>
  <body>
  ...
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
   ...
   <a href="login.php"><button class="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Log in
    </button></a>
  </div>
</header>
  <main>
    <div class="relative px-6 lg:px-8">
      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        ...
        <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">"Join the literary community and discover your next favorite book."<span class="type"></span></h1>
        <br>
